...
(FLIPBOOK.Book3 = function (t, e, i) {
  ...
  (this.$centerContainer = jQuery('<div>').appendTo(this.$wrapper).addClass('flipbook-center-container3')),
    this.options.singlePageMode && this.$centerContainer.css({ '-webkit-perspective-origin-x': '0', 'perspective-origin-x': '0' }),
  ...
  (FLIPBOOK.Book3.prototype.updateVisiblePages = function (t) {
    void 0 === t && (t = !0);
    for (var e = this, i = FLIPBOOK.IScroll.utils.style.transform, s = 0; s < this.pagesArr.length; s++)
      s == this.flippedleft ? this.pagesArr[s].show() : s != this.flippedleft - 1 || this.options.singlePageMode ? this.pagesArr[s].hide() : this.pagesArr[s].show(),
  ...
  (FLIPBOOK.Book3.prototype.goToPage = function (t, e) {
    if (this.enabled && !this.flipping)
      if (((this.options.singlePageMode || t % 2 != 0) && t--, t < 0 && (t = 0), t > this.pagesArr.length && (t = this.pagesArr.length), t != this.rightIndex)) {
        ...
        var o = this;
        (this.goingToPage = t) > this.rightIndex ? ((end = 180), (o.angle <= 0 || 180 <= o.angle || !o.angle) && (o.angle = 1)) : t < this.rightIndex && ((end = -180), (0 <= o.angle || o.angle <= -180 || !o.angle) && (o.angle = -1)),
  ...
  (FLIPBOOK.Book3.prototype._setPageAngle = function (t) {
    ...
    if (((this.angle = t), this.hideHtml(), this.options.singlePageMode))
      0 < t ? ((s = this.pagesArr[this.rightIndex])._setAngle(t / 2), (i = this.pagesArr[this.goingToPage]) && i.show()) : ((o = this.pagesArr[this.goingToPage]).show(), o._setAngle(t / 2 + 90), (s = this.pagesArr[this.rightIndex]));
    else if (0 < t) {
  ...
  (FLIPBOOK.Page3 = function (t, e, i, s) {
    ...
    var o = t.options;
    o.pagePreloader
      ? (this.$preloader = jQuery('<img src="' + o.pagePreloader + '" class="flipbook-page-preloader-image">').appendTo(this.$wrapper))
      : (this.$preloader = jQuery('<img src="' + o.assets.spinner + '" class="flipbook-page-preloader">').appendTo(this.$wrapper)),
      ...
      this.options.singlePageMode
        ? (this.$wrapper.addClass('flipbook-page3-front'), (this.type = 'front'))
        : e % 2 == 0
  ...
  (FLIPBOOK.Page3.prototype = {
    load: function (n) {
      if (1 != this.loaded) {
        ...
        h.options.pdfMode
          ? this.options.main.loadPage(t, this.options.pageTextureSize, function () {
              n && n.call(h);
            })
          : this.options.main.loadPage(t, this.options.pageTextureSize, function (t) {
              ...
              'left' == h.options.pages[t.index].side ? (scaleX = 2) : 'right' == h.options.pages[t.index].side ? ((s = '-50% '), (scaleX = 2)) : (scaleX = 1),
                jQuery(e)
                  .appendTo(h.$image)
                  .css(FLIPBOOK.IScroll.utils.style.transform, 'scaleX(' + scaleX + ') translateX(' + s + ') translateZ(0)');
              var o = t.htmlContent;
              !o || (h.options.doublePage && 0 != h.index && h.index % 2 == 0) || ((h.$html = jQuery(o).appendTo(h.$canvas)), (h.$html[0].style.transform = 'scale(' + h.htmlContentScale + ') translateZ(0)')),
                h.hidden && h.hideHtml(),
    ...
    setMat: function (t, e, i) {
      this.mat ||
        ...
        !e || (this.options.doublePage && 0 != this.index && this.index % 2 == 0) || ((this.$html = jQuery(e).appendTo(this.$canvas)), (this.$html[0].style.transform = 'scale(' + this.htmlContentScale + ') translateZ(0)')),
    ...
    _setAngle: function (t) {
      if (this.angle != t) {
        ...
        '3d' == this.book.options.viewMode
          ...
          : '2d' == this.book.options.viewMode && ('front' == this.type ? (90 < t && (t = 90), (e = 'scaleX(' + String((180 - 2 * t) / 180) + ') ' + o)) : (t < 90 && (t = 90), (e = 'scaleX(' + String((2 * t) / 180 - 1) + ') ' + o))),
