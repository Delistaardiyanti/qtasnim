    ...
    (FLIPBOOK.Main.prototype = {
        ...
        this.started || this.start(),
          void 0 !== this.Book
            ? (this.Book.enable(),
              ...
              this.gaCode && ga('send', { hitType: 'event', eventCategory: 'Flipbook : ' + this.options.name, eventAction: 'lightbox open', eventLabel: 'lightbox open', eventValue: this.lightboxStartedTimes, nonInteraction: !0 }),
      ...
      toggleShareMenu: function () {
        if (this.shareMenu) this.shareMenuShowing ? (this.shareMenu.hide(), (this.shareMenuShowing = !1)) : (this.shareMenu.show(), this.closeMenus(), (this.shareMenuShowing = !0));
          ...
          var o = M('<idv class="flipbook-share">').appendTo(t),
            i = this.options;
          (this.share = new Share(o[0], { networks: { google_plus: i.google_plus, twitter: i.twitter, facebook: i.facebook, pinterest: i.pinterest, email: i.email } })), this.closeMenus(), (this.shareMenuShowing = !0), this.initColors();
        }
      },
      ...
      downloadPage: function (e) {
        if (this.options.pages[e] && this.options.pages[e].download) url = this.options.pages[e].download;
          ...
          (t.width = this.options.pageTextureSize * o), (t.height = this.options.pageTextureSize), t.getContext('2d').drawImage(this.options.pages[e].canvas[this.options.pageTextureSize], 0, 0), (url = t.toDataURL('image/jpeg', 0.5));
        }
        if (url) {
    ...
    return (function (e) {
      ...
      return (
        ...
        (t.prototype.normalize_filter_config_updates = function (e) {
          return (
            this.config.networks.facebook.app_id !== e.app_id && (console.warn('You are unable to change the Facebook app_id after the button has been initialized. Please update your Facebook filters accordingly.'), delete e.app_id),
